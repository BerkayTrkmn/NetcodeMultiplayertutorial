...
namespace HelloScripts
{
    public class ObjectPooler : MonoBehaviour
    {
        ...
        public Dictionary<string, GameObject> poolParentDictionary;
        private void Awake()
        {
            #region Singleton
            if (instance == null)
            ...
            poolParentDictionary = new Dictionary<string, GameObject>();
        }
        ...
        public List<GameObject> PoolObject(GameObject poolobject, int objectNumber)
        {
            ...
            poolParentDictionary[parent.name] = parent;
        ...
        public void MovePooledObjects(Transform parent, GameObject pooledObject)
        {
            GameObject parentGO = poolParentDictionary[pooledObject.name + "Holder"];
            if (parentGO != null)
            {
